...
<body>
	<div class="container col-md-4">
		<h1>Adicionar novo agendamento jsp</h1>
		<form id="formAgendamento" name="fmAgendamento" action="insertA">
			...
			<div class="form-group">
				...
				<input required type="datetime-local" class="form-control" id="fmDataInicio" name="data-inicio">
				<div class="invalid-feedback">
			...
			<div class="form-group">
				...
				<input required type="datetime-local" class="form-control" id="fmDataFim" name="data-fim">
				<div class="invalid-feedback">
			...
			<div class="form-group">
				...
				<div class="input-group">
					...
					<input required type="text" class="form-control" id="fmValor" name="valor">
				</div>
				<div class="invalid-feedback">
